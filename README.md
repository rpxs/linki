...
<p>linki is a url shortener built with next.js and redis. built with simplicity in mind, it has one and one page only to create your links.
you can deploy your own instance of linki for free below :)
